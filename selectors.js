module.exports = {
    USERNAME_SELECTOR: "#user_name",
    PASSWORD_SELECTOR: "#user_pas",
    SUBMIT_BUTTON_SELECTOR: "#LoginForm > div:nth-child(6) > button",
    EXAMS_PAGE_SELECTOR: "#DersDonemParcaView > div > div > div > div.widget-header > h4",
